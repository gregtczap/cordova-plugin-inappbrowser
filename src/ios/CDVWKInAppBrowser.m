...
- (void)webView:(WKWebView *)theWebView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    //NOTE: The following condition has be modified to reflect the WKWebView fixes for tel and mailto links as noted in this issue: https://github.com/apache/cordova-plugin-inappbrowser/issues/592
